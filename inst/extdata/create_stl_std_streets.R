...
stl_std_streets <- dplyr::tibble(
  st.output = c("Kingshighway", "Dr Martin Luther King", "Dr Martin Luther King", "Dr Martin Luther King",
                "Redd Foxx",
                 "Dr Samuel T Shepard", "Dr Samuel T Shepard", "Dr Samuel T Shepard", "Mount Pleasant",
                 "Morgan Ford", "Lasalle","Lambdin", "Bishop P L Scott"),
  st.input = c("Kingshighway Memorial", "Martin Luther King", "Mlk", "Dr Martin Luther Kin",
               "Red Fox",
